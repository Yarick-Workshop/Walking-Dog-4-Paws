...
module dog_wheel_assembled(wheelWidth, spacerHeight, spacerDiameter, scaleFactor, shaftDiameter, delta, wheelRealDiameter, showDebugFigures)
{
    dog_wheel(
        wheelWidth = wheelWidth,
        spacerHeight = spacerHeight,
        spacerDiameter = spacerDiameter,
...
module dog_wheel(wheelWidth, spacerHeight, spacerDiameter, scaleFactor, shaftDiameter, delta, wheelRealDiameter, showDebugFigures)
{
